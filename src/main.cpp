...
#include <vector>
#include <memory>
#include "GLViewNat22_Final.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewNat22_Final > glView( Aftr::GLViewNat22_Final::New( args ) );
